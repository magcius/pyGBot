...
from pygbot.games.cardutil import Card, CardPile
from pygbot.games.fluxx.deck import FluxxDeck

class FluxxGame(object):
    """
    Keeps state of the Fluxx game.
    """
    def __init__(self):
        self.started = False
        self.finished = False
    ...
    def start_game(self):
        """
        Start the game by dealing to the players.
        """
        self.deal()
...
class DrawDiscard(object):
    ...
    def draw(self, num_cards):
        """
        Draw from the draw pile, with special
        logic to recycle the discard pile
    ...
    def deal(self, piles, num_cards):
        """
        Deal from the draw pile, num cards each.
        """
...
class FluxxCard(Card):
    def __init__(self, title, uid, description):
        Card.__init__(self, title, uid)
    ...
    def __str__(self):
        return "%s (%s)" % (self.title, self.uid)
